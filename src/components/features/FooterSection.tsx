...
export default function FooterSection({ settings }: { settings: SiteSettings | null }) {
  ...
  return (
    <footer style={{ background: 'var(--ds-fg)', color: 'var(--ds-bg)', padding: '30px 0' }}>
      ...
      >
        ...
        {email ? (
          <a href={`mailto:${email}`} className='transition-opacity duration-200 hover:opacity-70'>
            {email}
          </a>
        ) : (
          <span />
